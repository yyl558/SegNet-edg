...
def generate_train_dataset(
    ...
    images_path = ['dataset/origin/top_potsdam_2_10_RGB.tif', 'dataset/origin/top_potsdam_2_11_RGB.tif',
                   'dataset/origin/top_potsdam_2_12_RGB.tif', 'dataset/origin/top_potsdam_2_13_RGB.tif',
                   'dataset/origin/top_potsdam_2_14_RGB.tif', 'dataset/origin/top_potsdam_3_10_RGB.tif',
                   'dataset/origin/top_potsdam_3_11_RGB.tif', 'dataset/origin/top_potsdam_3_12_RGB.tif']
    labels_path = ['dataset/origin/top_potsdam_2_10_class.png', 'dataset/origin/top_potsdam_2_11_class.png',
                   'dataset/origin/top_potsdam_2_12_class.png', 'dataset/origin/top_potsdam_2_13_class.png',
                   'dataset/origin/top_potsdam_2_14_class.png', 'dataset/origin/top_potsdam_3_10_class.png',
                   'dataset/origin/top_potsdam_3_11_class.png', 'dataset/origin/top_potsdam_3_12_class.png']
